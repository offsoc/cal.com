...
// Mock the getAvailableSlots function
jest.mock("@calcom/platform-libraries/slots", () => ({
...
describe("SlotsService_2024_09_04", () => {
  ...
  describe("getAvailableSlots", () => {
    ...
    beforeEach(() => {
      ...
      mockGetAvailableSlots.mockResolvedValue(sharedTestData.mockSlotsResponse);
    });

    it.only("should call getAvailableSlots with correct routing parameters when withRouting is true", async () => {
      // Arrange
      const inputQuery = {
